...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.use("/api", laminateImageRouter); // Laminate image routes - protected (has internal auth middleware)
  ...
  // Laminate image routes moved to server/routes/laminateImage.routes.ts
