    ...
    <div className="flex-shrink-0 w-20 bg-slate-800 border-l border-slate-700 flex flex-col">
      <div className="flex-1 flex flex-col items-center py-2 px-1.5 gap-2 overflow-y-auto">
        ...
        <div className="flex-shrink-0 w-full">
          ...
          {roomPhoto ? (
            <div className="relative w-full aspect-[4/3] rounded overflow-hidden border-2 border-blue-500">
              <img
                src={roomPhoto.src}
                alt="Main photo"
        ...
        <div className="flex-1 w-full min-h-0">
          ...
          <div className="flex flex-col gap-1.5 overflow-y-auto">
            {referencePhotos.length > 0 ? (
              ...
              <div
                className="flex-shrink-0 w-full aspect-[4/3] rounded border border-dashed border-slate-600 flex items-center justify-center cursor-pointer hover:border-slate-500 transition-colors"
